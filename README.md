...
([`atem-overseer`](https://github.com/allansargeant/atem-overseer),
[`atem-fleet-admin`](https://github.com/allansargeant/atem-fleet-admin),
[`flock`](https://github.com/allansargeant/flock)), not built from source in this repo:
...
- **A pre-built Resolve project structure, generated by
  [resolve-configurator](https://github.com/allansargeant/resolve-configurator)** — a
