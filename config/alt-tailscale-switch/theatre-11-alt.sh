...
dhcp-host=REPLACE_WITH_MAC_03,192.168.12.5    # powerpoint-main
dhcp-host=REPLACE_WITH_MAC_04,192.168.12.6    # powerpoint-backup
dhcp-host=REPLACE_WITH_MAC_05,192.168.12.7    # vt-main
dhcp-host=REPLACE_WITH_MAC_06,192.168.12.8    # vt-backup
dhcp-host=REPLACE_WITH_MAC_07,192.168.12.10   # control-laptop
EOF
systemctl restart dnsmasq

# --- Tailscale — identical to the GL-iNet case, see ../tailscale-up-all-devices.sh
# tailscale up --advertise-routes=192.168.12.0/24 --accept-routes --advertise-tags=tag:theatre --hostname=theatre-11-router
